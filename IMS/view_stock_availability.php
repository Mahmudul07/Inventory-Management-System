...
if(!isset($_SESSION['username']) || $_SESSION['usertype'] !='admin'){
    ...
    <div id="wrapper">
        ...
        $targetpage = "view_stock_availability.php";
        $limit = 40;
        if(isset($_GET['limit']))
            $limit=$_GET['limit'];
        $page = $_GET['page'];
        ...
        ?>
        <div id="page-wrapper">
            <div class="container-fluid" style="margin-bottom: 07%">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form role="form" name="deletefiles" action="deleteselected.php" method="post" >
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading" align="center">
                                    <h1 class="panel-title"> View Stock Availability</h1>
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <form role="form" name="deletefiles" action="deleteselected.php" method="post" >
                                                ...
                                                <table class="table table-bordered table-hover table-striped">
                                                    ...
                                                    while($row = mysql_fetch_array($result))
                                                    {
                                                        ...
                                                        <tr>
                                                          ...
                                                          <!--  <td> <a href="update_stock_entries.php?id=<?php echo $row['id'];?>"><span class=" glyphicon glyphicon-pencil"></a></td>
                                                            <td><a onclick="return confirmSubmit()"
                                                          href="delete.php?tid=<?php echo $row['id']; ?>&table=stock_sales&return=view_stock_sales.php"><span class="glyphicon glyphicon-trash"></span></a>
                                                            </td>
                                                            -->
								                         </tr>
                                                        <?php
