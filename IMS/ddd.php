...
if(!isset($_SESSION['username']) || $_SESSION['usertype'] !='admin'){
    ...
    <head>
        ...
        <link rel="stylesheet" href="Knight/css/style.css" type="text/css" media="screen" title="no title" charset="utf-8" />
        <link rel="icon" href="Knight/favicon.png" type="image/png">
                                        ...
                                        <form role="form" name="salesform" method="post" id="form1" action="" onSubmit="updateSubtotal()">
                                            <table   border="0" cellspacing="0" cellpadding="0"  id="dynamictable">
                                                ...
                                                <tr>
                                                    <div class="form-group-md" align="right">
                                                        ...
                                                        $autoid="PR".$max."";
                                                        ?>
                                                        <td> <input class="form-control" name="id" type="text" id="id" readonly="" value="<?php echo $autoid; ?>" style="width:90px;"></td>
                                                        <td>&nbsp;</td>
                                                        <td><strong>Date</strong></td>
                                                        <td><input class="form-control" type="text" id="datefield" name="date" class="date_input" value="<?php echo date('d-m-Y');?>" style="width:90px;"></td>
                                                        <br>
                                                        <br>
                                                    </div>
                                                </tr>
                                                ...
                                                <tr>
                                                    <div class="form-group-md" align="center">
                                                        ...
                                                        <td><input class="form-control" type="text" name="billnumber" style="width:100px;" id="billnumber" class="validate[required,length[0,100]] text-input"></td></td>
                                                        <td>&nbsp;</td>
                                                        <td><strong>Supplier</strong></td>
                                                        <td><input class="form-control" name="supplier" type="text" id="supplier"  value="" style="width:100px;" autocomplete="off" ></td>
                                                        <td>&nbsp;</td>
                                            ...
                                            <table  border="0" cellspacing="0" cellpadding="0"  id="duplicate" style="">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td ><input name="name[]" class="form-control" type="text"  id="0"   style="width:100px;" onFocus="callAutoComplete(this.id)"  onBlur="callAutoAsignValue(this.id)" autocomplete="off"></td>
                                            ...
                                            <table  border="0" align="center" cellpadding="0" cellspacing="0"  id="duplicate" style="">
                                                <div class="form-group-md">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="195"><input type="text" class="form-control" id="due" name="due" class="date_input" value="<?php echo date('d-m-Y');?>" style="width:100px;"></td>
                                                        <td width="77">&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;</td>
                                                        <td><input type="submit" class="btn btn-default" name="Submit" value="Save" onClick="updateSubtotal()" ></td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
