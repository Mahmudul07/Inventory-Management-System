                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading" align="center">
                                <h1 class="panel-title"> Add Stock Entries Payment</h1>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    if(isset($_POST['id']))
                                    {
                                        ...
                                        if($db->query("UPDATE stock_entries  SET balance=$balance,payment=$payment,due='$due' where stock_id='$id'"))
                                        {
                                            ...
                                            echo "<meta http-equiv='refresh' content='0;url=view_stock_entries_payments.php'>";
                                    ...
                                    <div class="col-lg-6 col-md-offset-3">
                                        <form role="form" name="form1" method="post" id="form1" action="" align="center">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="eid" type="text" id="eid"  value="<?php echo $line->stock_id; ?>" readonly="">
                                            </div>

                                            <div class="form-group">
                                                <label>Supplier</label>
                                                <input class="form-control" name="supplier" type="text" id="supplier"  value="<?php echo $line->stock_supplier_name; ?>" readonly="">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label>Paid</label>
                                                <input class="form-control" name="payment" type="text" id="payment"   value="<?php echo $line->payment;?>" readonly="">
                                            </div>
                                          ...
                                          <a href="view_stock_entries_payments.php"><input type="button" name="Reset" value="Cancle" class="btn btn-primary"></a>
                                        </form>
                                    </div>
                                </div>
                            </div>
